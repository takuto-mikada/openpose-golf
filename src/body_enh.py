...
class Body(object):
    ...
    def __call__(self, oriImg, TRAIN=True):
        ...
        for m in range(len(multiplier)):
            ...
            with torch.no_grad():
                featureImage, Mconv7_stage6_L1, Mconv7_stage6_L2 = self.model(data)
            ...
            if TRAIN:
                ...
                tippoint_L1 = np.reshape(tippoint_L1, (135, 240, 2))
